package br.com.zup.challenge.config.validacao;
...
public class ErroDeValidacaoHandler {
	...
	public List<ErroDeFormulario> handle(MethodArgumentNotValidException exception){
		...
		fieldErrors.forEach(e -> {
			...
			dto.add(new ErroDeFormulario(e.getField(), mensagem));
		});
	...
	public ErroDeFormulario handle(ErroDeFormularioException exception){
		return exception.getErroDeFormulario();
	}
